var cameraDefs = {
    ...
    'iXon888' : {
        ...
        'iXon897' : {
            shortName : 'iXonUltra897',
            xPixels : 512,
            yPixels : 512,
            xPixelSize : 16,
            yPixelSize : 16,    
            readNoise : 0.13,
            // do readnoise as an object to store multiple key:value pairs
            readNoises : {'conv-0.08':2.7, 'conv-1':5.3, 'conv-3':9.6, 'em-1':15, 'em-5':37, 'em-10':65, 'em-17':89},
            QE : 0.95,
            CIC : 0.0018,
            darkCurrent : 0.00015,
            frameRateHz : 26,
